    ...
    <div className="work-permit-container">
      <div className="work-permit-card">
        ...
        <p className="work-permit-summary">
          I am a citizen of India 🇮🇳 and fully eligible to work across India. I am open to on-site, hybrid, and remote opportunities within India, and available to collaborate with teams across the country on a full-time or project basis. Eligible to work for any employer in India, giving me the opportunity to build valuable experience and grow my career here. 🌟
        </p>
